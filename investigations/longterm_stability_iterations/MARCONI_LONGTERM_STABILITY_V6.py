...
OUT_DIR=BASE_DIR/'marconi_longterm_v6'; PLOT_DIR=OUT_DIR/'track_plots'; RESID_DIR=OUT_DIR/'residual_plots'
OUT_CSV=OUT_DIR/'marconi_longterm_track_diagnostics_v6.csv'; OUT_POP_CSV=OUT_DIR/'marconi_longterm_population_statistics_v6.csv'; OUT_SUMMARY=OUT_DIR/'marconi_longterm_summary_v6.txt'
...
def main():
    ...
    banner('MARCONI LONG-TERM GNSS-R / TIDE PIPELINE V6');print('Base directory:',BASE_DIR);print('REFL_CODE:',REFL_CODE);print('Result directory:',RESULT_DIR);print('Diagnostic offset: +0.242 m');print('GOOD thresholds unchanged from V5. +0.242 m is diagnostic only.')
    rows=load_results()
