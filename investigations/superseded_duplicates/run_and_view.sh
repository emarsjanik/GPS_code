...
#   1. Process any new GPS data and regenerate all standard plots
#   2. Find the most recent day-of-year stretch we have result files
...
#   3. Change into the folder where every plot (including the new
...
echo "================================================================"
echo "  Step 1: Processing GPS data"
echo "================================================================"
...
echo ""
echo "================================================================"
echo "  Step 2: Finding a genuinely gap-free stretch and generating"
...
if [ -z "$day_files" ]; then
    ...
    echo ""
    echo "================================================================"
    echo "  Step 3: Overlaying with real tide models"
    echo "================================================================"
...
echo ""
echo "================================================================"
echo "  Step 4: Moving to the plots directory"
echo "================================================================"
