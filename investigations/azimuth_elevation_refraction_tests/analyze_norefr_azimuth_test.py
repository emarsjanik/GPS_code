...
but on the ocean17_23_norefr dataset (refraction correction disabled)
...
RESULT_DIR = Path("products/refl_code/2026/results/usgs/ocean17_23_norefr")
...
print()
print(f"corr(azimuth, |r|), NO refraction correction: {np.corrcoef(az, rvals)[0,1]:+.4f}")
print()
print("Compare directly against the WITH-refraction-correction result")
print("from the same 17-23m dataset found earlier tonight:")
print("  corr(azimuth, |r|), WITH refraction correction: -0.4156 (N>=10 tracks)")
